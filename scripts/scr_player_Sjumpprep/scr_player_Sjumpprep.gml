function state_player_Sjumpprep()
{
	...
	if (floor(image_index) == (image_number - 1) && sprite_index == spr_player_superjumpprep)
		sprite_index = spr_player_superjumppreplight;
	if (!key_up && (grounded || Sjumpcan_doublejump == 1) && (sprite_index == spr_player_superjumppreplight || sprite_index == spr_player_superjumpleft || sprite_index == spr_player_superjumpright || sprite_index == spr_pizzano_sjumpprep) && !scr_solid(x, y - 16) && !scr_solid(x, y - 32))
	{
