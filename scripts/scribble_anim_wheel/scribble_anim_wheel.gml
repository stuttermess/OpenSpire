...
{
    if ((_size     != global.__scribble_anim_properties[__SCRIBBLE_ANIM.__WHEEL_SIZE ])
    || (_frequency != global.__scribble_anim_properties[__SCRIBBLE_ANIM.__WHEEL_FREQ ])
    || (_speed     != global.__scribble_anim_properties[__SCRIBBLE_ANIM.__WHEEL_SPEED]))
    {
        global.__scribble_anim_properties[@ __SCRIBBLE_ANIM.__WHEEL_SIZE ] = _size;
        global.__scribble_anim_properties[@ __SCRIBBLE_ANIM.__WHEEL_FREQ ] = _frequency;
        global.__scribble_anim_properties[@ __SCRIBBLE_ANIM.__WHEEL_SPEED] = _speed;
